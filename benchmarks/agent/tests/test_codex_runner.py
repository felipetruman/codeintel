...
def task() -> BenchmarkTask:
    return BenchmarkTask(
        ...
        prompt=(
            "Find callers of process_payment."
        ),
...
def test_codeintel_arm_adds_inline_mcp(
    ...
    assert (
        'mcp_servers.codeintel.command="/opt/codeintel"'
        in overrides
    )
